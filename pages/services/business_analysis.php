...
<div id="BusinessAnalysis" class="box">
    ...
    <?php
            ...
            // Benefits
            include($root."/assets/includes/sections/services/business_analysis/business_analysis_benefits.php");      
            
            // Prices
            include($root."/assets/includes/sections/services/business_analysis/business_analysis_prices.php");

            // Portfolio
            //include($root."/assets/includes/sections/services/business_analysis/business_analysis_portfolio.php");
            
            // Next Steps
            include($root."/assets/includes/sections/services/business_analysis/business_analysis_next_steps.php");
