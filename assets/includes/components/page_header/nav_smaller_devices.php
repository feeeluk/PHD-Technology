<details id="DisclosureOne">
    ...
    <nav id="NavbarForMobile">
        ...
        <a href="/"><span class="smallDeviceMenuLink">Home</span></a>
        <a href="/pages/about.php"><span class="smallDeviceMenuLink">About</span></a>
        ...
        <!-- <a href="/pages/case_studies.php"><span class="smallDeviceMenuLink">Case Studies</span></a> -->
        <a href="/pages/portfolio.php"><span class="smallDeviceMenuLink">Portfolio</span></a>
        <a href="/pages/contact.php"><span class="smallDeviceMenuLink">Contact</span></a>
